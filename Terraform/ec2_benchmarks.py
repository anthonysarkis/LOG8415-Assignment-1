...
# docker run -e load_balancer="app/load-balancer/dfd7de50da537297" -e cluster1="targetgroup/M4-instances/d9cca333fc82aa43" -e cluster2 = "targetgroup/T2-instances/1c4d5351a9b4c048" ec2_benchmarks
...
def get_metric_data(metric, targetGroup1ARN, targetGroup2ARN, loadBalancer):
    ...
    average = metric == 'TargetResponseTime' or metric == 'HealthyHostCount' or metric == 'UnHealthyHostCount'
